...
set_property -dict { PACKAGE_PIN BA19  IOSTANDARD LVCMOS15 } [get_ports { uart_tx_serial_o }]; #IO_L24N_T3_32 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN AY19  IOSTANDARD LVCMOS15 } [get_ports { uart_rx_serial_i }]; #IO_L24P_T3_32 Sch=uart_txd_in
