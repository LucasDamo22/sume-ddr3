...
namespace eval ::optrace {
  variable script "/sim/freq-test/ddr3-pack/ddr3-sume/ddr3-sume.runs/synth_1/top.tcl"
...
set_property used_in_implementation false [get_files /sim/freq-test/ddr3-pack/ddr3_tb/SUME_Master.xdc]
